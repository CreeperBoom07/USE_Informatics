...
### <h3 >Я создал этот репозиторий, чтобы сохранить файлы с материалами для подготовки к ЕГЭ по информатике 2024.</h3> 
____
## <h2 align='center'>📈Общий прогресс по экзамену</h2>
#### <h4 align='center'> <img height="60" src="https://geps.dev/progress/58" width="400"/> </h4>
